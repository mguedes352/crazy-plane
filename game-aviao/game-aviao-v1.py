...
predios1_surface = pygame.image.load('background/background.png').convert_alpha()
predios2_surface = pygame.image.load('background/background.png').convert_alpha()
aviao_surface = pygame.image.load("avioes/aviao-john.png").convert_alpha()
